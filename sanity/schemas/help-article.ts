  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        {
          name: "reviewScore",
          title: "Review Score (0-100)",
          type: "number",
        },
        {
          name: "publishingRecommendation",
          title: "Publishing Recommendation",
          type: "string",
          options: {
            list: [
        ...
        {
          name: "reviewAgentVersion",
          title: "Review Agent Version",
          type: "string",
        },
        {
